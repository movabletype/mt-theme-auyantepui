...
3. Sign into the your MT and create a new Custom Fields on the system. Detail is [here (ja)](https://github.com/movabletype/mt-theme-auyantepui/wiki/インストール-＆-カスタマイズ)
